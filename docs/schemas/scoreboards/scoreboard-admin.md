...
│  ┌────────────────────────────────────────────────────────────┐     │
│  │  Home Roster:                                         │     │
│  │  [Player 1] [Number] [Position] [◉ Start] [Save]    │     │
│  │  [Player 2] [Number] [Position] [○ Start] [Save]    │     │
│  │                                                         │     │
│  │  Away Roster:                                         │     │
│  │  [Player 1] [Number] [Position] [◉ Start] [Save]    │     │
  │  │  [Player 2] [Number] [Position] [○ Start] [Save]    │     │
...
- **"Hide All Forms" button** → Collapse all admin forms
- **Collapsible form sections** with toggle buttons:
  ...
  - **Roster Forms** → Manage player rosters for both teams
